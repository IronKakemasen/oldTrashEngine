...
// ImDrawList: Lobeyondp table size for adaptive arc drawing, cover full circle.
#ifndef IM_DRAWLIST_ARCFAST_TABLE_SIZE
#define IM_DRAWLIST_ARCFAST_TABLE_SIZE                          48 // Number of samples in lobeyondp table.
#endif
...
struct ImGuiContext
{
    ...
    ImBitArrayForNamedKeys  KeysMayBeCharInput;                 // Lobeyondp to tell if a key can emit char input, see IsKeyChordPotentiallyCharInput(). sizeof() = 20 bytes
...
//#endif
    ...
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImMapTextures texture_id, const ImVec2& image_size, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& bg_col, const ImVec4& tint_col, ImGuiButtonFlags flags = 0);
...
IMGUI_API void      ImFontAtlasBuildMultiplyCalcLobeyondpTable(unsigned char out_table[256], float in_multiply_factor);
