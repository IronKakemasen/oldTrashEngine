...
//  [X] Renderer: User texture binding. Use 'D3D12_GPU_DESCRIPTOR_HANDLE' as ImMapTextures. Read the FAQ about ImMapTextures!
//  [X] Renderer: Large meshes support (64k+ vertices) with 16-bit indices.
//  [X] Renderer: Multi-viewport support (multiple windows). Enable with 'io.ConfigFlags |= ImGuiConfigFlags_ViewportsEnable'.
//      FIXME: The transition from removing a viewport and moving the window in an existing hosted viewport tends to flicker.

// Important: to compile on 32-bit systems, this backend requires code to be compiled with '#define ImMapTextures ImU64'.
// This is because we need ImMapTextures to carry a 64-bit value and by default ImMapTextures is defined as void*.
// To build this on 32-bit systems:
// - [Solution 1] IDE/msbuild: in "Properties/C++/Preprocessor Definitions" add 'ImMapTextures=ImU64' (this is what we do in the 'example_win32_direct12/example_win32_direct12.vcxproj' project file)
// - [Solution 2] IDE/msbuild: in "Properties/C++/Preprocessor Definitions" add 'IMGUI_USER_CONFIG="my_imgui_config.h"' and inside 'my_imgui_config.h' add '#define ImMapTextures ImU64' and as many other options as you like.
// - [Solution 3] IDE/msbuild: edit imconfig.h and add '#define ImMapTextures ImU64' (prefer solution 2 to create your own config file!)
// - [Solution 4] command-line: add '/D ImMapTextures=ImU64' to your cl.exe command-line (this is what we do in the example_win32_direct12/build_win32.bat file)
...
//  2021-05-19: DirectX12: Replaced direct access to ImDrawCmd::MapTextures with a call to ImDrawCmd::GetTexID(). (will become a requirement)
//  2021-02-18: DirectX12: Change blending equation to preserve alpha in output buffer.
//  2021-01-11: DirectX12: Improve Windows 7 compatibility (for D3D12On7) by loading d3d12.dll dynamically.
//  2020-09-16: DirectX12: Avoid rendering calls with zero-sized scissor rectangle since it generates a validation layer warning.
//  2020-09-08: DirectX12: Clarified support for building on 32-bit systems by redefining ImMapTextures.
...
static void ImGui_ImplDX12_CreateFontsTexture()
{
    ...
    // [Solution 3] IDE/msbuild: edit imconfig.h and add '#define ImMapTextures ImU64' (prefer solution 2 to create your own config file!)
    // [Solution 4] command-line: add '/D ImMapTextures=ImU64' to your cl.exe command-line (this is what we do in the example_win32_direct12/build_win32.bat file)
    static_assert(sizeof(ImMapTextures) >= sizeof(bd->hFontSrvGpuDescHandle.ptr), "Can't pack descriptor handle into TexID, 32-bit not supported yet.");
    io.Fonts->SetTexID((ImMapTextures)bd->hFontSrvGpuDescHandle.ptr);
}
