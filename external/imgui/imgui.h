...
// - To use something else than an opaque void* pointer: override with e.g. '#define ImMapTextures MyTextureType*' in your imconfig.h file.
// - This can be whatever to you want it to be! read the FAQ about ImMapTextures for details.
#ifndef ImMapTextures
typedef void* ImMapTextures;          // Default: store a pointer or an integer fitting in a pointer (most renderer backends are ok with that)
#endif
...
namespace ImGui
{
    ...
    // Widgets: Images
    // - Read about ImMapTextures here: https://github.com/ocornut/imgui/wiki/Image-Loading-and-Displaying-Examples
    // - 'uv0' and 'uv1' are texture coordinates. Read about them from the same link above.
    // - Note that Image() may add +2.0f to provided size if a border is visible, ImageButton() adds style.FramePadding*2.0f to provided size.
    IMGUI_API void          Image(ImMapTextures user_texture_id, const ImVec2& image_size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0));
    IMGUI_API bool          ImageButton(const char* str_id, ImMapTextures user_texture_id, const ImVec2& image_size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1));
...
// This is optimized for efficient lobeyondp (dichotomy into a contiguous buffer) and rare insertion (typically tied to user interactions aka max once a frame)
...
// - The ClipRect/MapTextures/VtxOffset fields must be contiguous as we memcmp() them together (this is asserted for).
struct ImDrawCmd
{
    ImVec4          ClipRect;           // 4*4  // Clipping rectangle (x1, y1, x2, y2). Subtract ImDrawData->DisplayPos to get clipping rectangle in "viewport" coordinates
    ImMapTextures     MapTextures;          // 4-8  // User-provided texture ID. Set by user in ImfontAtlas::SetTexID() for fonts or passed to Image*() functions. Ignore if never using images or multiple fonts atlas.
    ...
    // Since 1.83: returns ImMapTextures associated with this draw call. Warning: DO NOT assume this is always same as 'MapTextures' (we will change this function for an upcoming feature)
    inline ImMapTextures GetTexID() const { return MapTextures; }
};
...
struct ImDrawList
{
    ...
    ImVector<ImMapTextures>   _MapTexturesStack;    // [Internal]
    ...
    IMGUI_API void  PopClipRect();
    IMGUI_API void  PushMapTextures(ImMapTextures texture_id);
    IMGUI_API void  PopMapTextures();
    ...
    // Image primitives
    // - Read FAQ to understand what ImMapTextures is.
    // - "p_min" and "p_max" represent the upper-left and lower-right corners of the rectangle.
    // - "uv_min" and "uv_max" represent the normalized texture coordinates to use for those corners. Using (0,0)->(1,1) texture coordinates will generally display the entire texture.
    IMGUI_API void  AddImage(ImMapTextures user_texture_id, const ImVec2& p_min, const ImVec2& p_max, const ImVec2& uv_min = ImVec2(0, 0), const ImVec2& uv_max = ImVec2(1, 1), ImU32 col = IM_COL32_WHITE);
    IMGUI_API void  AddImageQuad(ImMapTextures user_texture_id, const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, const ImVec2& uv1 = ImVec2(0, 0), const ImVec2& uv2 = ImVec2(1, 0), const ImVec2& uv3 = ImVec2(1, 1), const ImVec2& uv4 = ImVec2(0, 1), ImU32 col = IM_COL32_WHITE);
    IMGUI_API void  AddImageRounded(ImMapTextures user_texture_id, const ImVec2& p_min, const ImVec2& p_max, const ImVec2& uv_min, const ImVec2& uv_max, ImU32 col, float rounding, ImDrawFlags flags = 0);
    ...
    IMGUI_API void  _OnChangedMapTextures();
...
//    This value will be passed back to you during rendering to identify the texture. Read FAQ entry about ImMapTextures for more details.
// Common pitfalls:
...
struct ImFontAtlas
{
    ...
    void                        SetTexID(ImMapTextures id)    { TexID = id; }
    ...
    ImMapTextures                 TexID;              // User data to refer to the texture once it has been uploaded to user's graphic systems. It is passed back to you during rendering via the ImDrawCmd structure.
...
struct ImFont
{
    ...
    ImVector<ImWchar>           IndexLobeyondp;        // 12-16 // out //            // Sparse. Index glyphs by Unicode code-point.
    ...
    bool                        DirtyLobeyondpTables;  // 1     // out //
    ...
    // [Internal] Don't use!
    IMGUI_API void              BuildLobeyondpTable();
...
namespace ImGui
{
    ...
    IMGUI_API bool      ImageButton(ImMapTextures user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1)); // Use new ImageButton() signature (explicit item id, regular FramePadding)
