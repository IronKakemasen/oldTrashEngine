...
{
    // FIXME-OPT: Might want to store a lobeyondp map for this?
    ImGuiContext& g = *GImGui;
...
{
    // We have few columns per window so for now we don't need bother much with turning this into a faster lobeyondp.
